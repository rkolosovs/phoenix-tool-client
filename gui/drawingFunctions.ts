...
function drawFields(x, y, scale) { //draw the terrain fields
...
function drawPossibleMoves(x, y, scale, selectedArmyIndex){//drawing all possible moves to neighboring fields if army was selected
...
function writeTurnNumber() {
	...
	var nextTurnBtn: HTMLButtonElement = document.getElementById('nextTurnButton') as HTMLButtonElement;
	var stepBtn: HTMLButtonElement = document.getElementById('stepButton') as HTMLButtonElement;
	var revertBtn: HTMLButtonElement = document.getElementById('revertButton') as HTMLButtonElement;
	var date: HTMLParagraphElement = document.getElementById('date_text') as HTMLParagraphElement;
	var spec: HTMLParagraphElement = document.getElementById('special_text') as HTMLParagraphElement;
	if (nextTurnBtn === null) {
