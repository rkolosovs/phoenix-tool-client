...
function drawBorders(ctx, x, y, scale) {
    ...
    for (var i = 0; i < borders.length; i++) {
        ...
        for (var j = 0; j < land.length; j++) {
            ...
            if (neighbours[0]) {
                if (neighbours[1]) {
                    ctx.lineTo((point[0] + gW), (point[1] + c));
                }
                else {
                    ctx.lineTo((point[0] + gW - SIN60 * offset), (point[1] + c - 0.5 * offset));
                }
            ...
            if (neighbours[1]) {
                if (neighbours[2]) {
                    ctx.lineTo((point[0] + gW), (point[1] + gH));
                }
                else {
                    ctx.lineTo((point[0] + gW), (point[1] + gH - offset));
                }
            }
            else {
                if (neighbours[2]) {
            ...
            if (neighbours[2]) {
                if (neighbours[3]) {
                    ctx.lineTo((point[0] + 0.5 * gW), (point[1] + scale));
                }
                else {
                    ctx.lineTo((point[0] + 0.5 * gW + SIN60 * offset), (point[1] + scale - 0.5 * offset));
                }
            ...
            if (neighbours[4]) {
                if (neighbours[5]) {
                    ctx.lineTo(point[0], (point[1] + c));
                }
                else {
                    ctx.lineTo(point[0], (point[1] + c + offset));
                }
            }
            else {
                if (neighbours[5]) {
...
function drawPossibleMoves(ctx, x, y, scale, selectedArmyIndex) {
