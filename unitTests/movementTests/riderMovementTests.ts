...
export function riderMovementTests() {
    ...
    test( "Lowlands -> woods on street", function(t: any) {
        ...
        GameState.buildings = [new NonDestructibleBuilding(BuildingType.STREET, [0, 0], [0, -1], GameState.realms[0])];
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(5, 0, false, false, [0, -1], Direction.NW));
    });
    ...
    test( "Hills -> woods", function(t: any) {
        ...
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(10, 2, false, false, [0, -1], Direction.NW));
    });
    test( "Hills -> woods on street", function(t: any) {
        ...
        GameState.buildings = [new NonDestructibleBuilding(BuildingType.STREET, [0, 0], [0, -1], GameState.realms[0])];
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(5, 1, false, false, [0, -1], Direction.NW));
    });
    test( "Hills -> woods in homeland", function(t: any) {
        ...
        GameState.realms[0].territory = GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(5, 2, false, false, [0, -1], Direction.NW));
    });
    ...
    test( "Hills -> highlands", function(t: any) {
        ...
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(21, 2, false, false, [0, -1], Direction.NW));
    });
    ...
    test( "Shallows -> woods", function(t: any) {
        ...
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(10, 2, false, true, [0, -1], Direction.NW));
    });
    test( "Shallows -> woods with harbor", function(t: any) {
        ...
        GameState.buildings = [new NonDestructibleBuilding(BuildingType.HARBOR, [0, -1], [0, 0], GameState.realms[0])];
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(10, 1, false, true, [0, -1], Direction.NW));
    });
    test( "Shallows -> woods in homeland", function(t: any) {
        ...
        GameState.realms[0].territory = GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(5, 2, false, true, [0, -1], Direction.NW));
    });
    test( "Shallows -> woods with harbor in homeland", function(t: any) {
        ...
        GameState.realms[0].territory = GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
        army.clickedMoves();
        t.movePossible( army.possibleMoves, new Move(5, 1, false, true, [0, -1], Direction.NW));
    });
