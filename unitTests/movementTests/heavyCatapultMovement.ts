...
export function heavyCatapultMovementTests() {
    test( "Lowlands -> lowlands", function(t: any) {
        let army = new FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
    ...
    test( "Lowlands -> lowlands on street", function(t: any) {
        let army = new FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        GameState.fields = [{'x':0, 'y':0, 'type':2}, {'x':0, 'y':-1, 'type':2}];
        GameState.buildings = [{'realm': 1, 'name': '', 'type': 8, 'firstX': 0, 'firstY': 0, 'secondX': 0, 'secondY': -1}];
        army.clickedMoves();
    ...
    test( "Lowlands -> shallows", function(t: any) {
        let army = new FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new Fleet(311, 31, 1, 0, 0, false, 0, -1, 1);
    ...
    test( "Shallows -> lowlands", function(t: any) {
        let army = new FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new Fleet(311, 31, 1, 0, 0, false, 0, 0, 1);
        GameState.armies = [army, fleet];
        fleet.loadArmy(army);
    ...
    test( "Shallows -> shallows", function(t: any) {
        let army = new FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new Fleet(311, 31, 1, 0, 0, false, 0, 0, 1);
        let anotherFleet = new Fleet(322, 31, 1, 0, 0, false, 0, -1, 1);
