...
export function heavyCatapultMovementTests() {
    test( "Lowlands -> lowlands", function(t: any) {
        let army = new FootArmy(111, GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], FootArmy.MAX_MOVE_POINTS, 2);
    ...
    test( "Lowlands -> shallows", function(t: any) {
        let army = new FootArmy(111, GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], FootArmy.MAX_MOVE_POINTS, 2);
        let fleet = new Fleet(311, GameState.realms[0], 31, 1, 0, 0, [0, -1], Fleet.MAX_MOVE_POINTS, false);
    ...
    test( "Shallows -> lowlands", function(t: any) {
        let army = new FootArmy(111, GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], FootArmy.MAX_MOVE_POINTS, 2);
        let fleet = new Fleet(311, GameState.realms[0], 31, 1, 0, 0, [0, 0], Fleet.MAX_MOVE_POINTS, false);
        GameState.armies = [army, fleet];
        fleet.loadArmy(army);
    ...
    test( "Shallows -> shallows", function(t: any) {
        let army = new FootArmy(111, GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], FootArmy.MAX_MOVE_POINTS, 2);
        let fleet = new Fleet(311, GameState.realms[0], 31, 1, 0, 0, [0, 0], Fleet.MAX_MOVE_POINTS, false);
        let anotherFleet = new Fleet(322, GameState.realms[0], 31, 1, 0, 0, [0, -1], Fleet.MAX_MOVE_POINTS, false);
