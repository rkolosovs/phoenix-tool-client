...
export function lightWarshipMovementTests() {
    test( "Shallows -> lowlands", function(t: any) {
        let fleet = new Fleet(311, GameState.realms[0], 21, 1, 1, 0, [0, 1], Fleet.MAX_MOVE_POINTS, false);
    ...
    test( "Shallows -> shallows on coast", function(t: any) {
        ...
        fleet.clickedMoves();
        t.movePossible( fleet.possibleMoves, new Move(6, 0, false, false, [0, -1], Direction.NW));
    });
