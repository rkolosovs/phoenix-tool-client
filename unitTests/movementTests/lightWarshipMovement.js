...
function lightWarshipMovementTests() {
    test("Shallows -> lowlands", function (t) {
        let fleet = new fleet_1.Fleet(311, gameState_1.GameState.realms[0], 21, 1, 1, 0, [0, 1], fleet_1.Fleet.MAX_MOVE_POINTS, false);
    ...
    test("Shallows -> shallows on coast", function (t) {
        ...
        fleet.clickedMoves();
        t.movePossible(fleet.possibleMoves, new move_1.Move(6, 0, false, false, [0, -1], 0 /* NW */));
    });
...
exports.lightWarshipMovementTests = lightWarshipMovementTests;
//# sourceMappingURL=lightWarshipMovement.js.map