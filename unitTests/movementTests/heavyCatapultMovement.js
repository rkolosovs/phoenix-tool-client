...
define(["require", "exports", "../../armies/footArmy", "../../armies/fleet", "../../gameState", "../../map/field", "../../armies/move", "../../buildings/nonDestructibleBuilding", "../qunit"], function (require, exports, footArmy_1, fleet_1, gameState_1, field_1, move_1, nonDestructibleBuilding_1, qunit_1) {
    ...
    function heavyCatapultMovementTests() {
        test("Lowlands -> lowlands", function (t) {
            let army = new footArmy_1.FootArmy(111, gameState_1.GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], footArmy_1.FootArmy.MAX_MOVE_POINTS, 2);
        ...
        test("Lowlands -> shallows", function (t) {
            let army = new footArmy_1.FootArmy(111, gameState_1.GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], footArmy_1.FootArmy.MAX_MOVE_POINTS, 2);
            let fleet = new fleet_1.Fleet(311, gameState_1.GameState.realms[0], 31, 1, 0, 0, [0, -1], fleet_1.Fleet.MAX_MOVE_POINTS, false);
        ...
        test("Shallows -> lowlands", function (t) {
            let army = new footArmy_1.FootArmy(111, gameState_1.GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], footArmy_1.FootArmy.MAX_MOVE_POINTS, 2);
            let fleet = new fleet_1.Fleet(311, gameState_1.GameState.realms[0], 31, 1, 0, 0, [0, 0], fleet_1.Fleet.MAX_MOVE_POINTS, false);
            gameState_1.GameState.armies = [army, fleet];
            fleet.loadArmy(army);
        ...
        test("Shallows -> shallows", function (t) {
            let army = new footArmy_1.FootArmy(111, gameState_1.GameState.realms[0], 1000, 1, 0, 1, 0, [0, 0], footArmy_1.FootArmy.MAX_MOVE_POINTS, 2);
            let fleet = new fleet_1.Fleet(311, gameState_1.GameState.realms[0], 31, 1, 0, 0, [0, 0], fleet_1.Fleet.MAX_MOVE_POINTS, false);
            let anotherFleet = new fleet_1.Fleet(322, gameState_1.GameState.realms[0], 31, 1, 0, 0, [0, -1], fleet_1.Fleet.MAX_MOVE_POINTS, false);
    ...
    exports.heavyCatapultMovementTests = heavyCatapultMovementTests;
});
//# sourceMappingURL=heavyCatapultMovement.js.map