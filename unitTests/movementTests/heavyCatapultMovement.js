...
function heavyCatapultMovementTests() {
    ...
    test("Lowlands -> shallows", function (t) {
        let army = new footArmy_1.FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new fleet_1.Fleet(311, 31, 1, 0, 0, false, 0, -1, 1);
    ...
    test("Shallows -> lowlands", function (t) {
        let army = new footArmy_1.FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new fleet_1.Fleet(311, 31, 1, 0, 0, false, 0, 0, 1);
        gameState_1.GameState.armies = [army, fleet];
        fleet.loadArmy(army);
    ...
    test("Shallows -> shallows", function (t) {
        let army = new footArmy_1.FootArmy(111, 1000, 1, 0, 1, 0, false, 0, 0, 1);
        let fleet = new fleet_1.Fleet(311, 31, 1, 0, 0, false, 0, 0, 1);
        let anotherFleet = new fleet_1.Fleet(322, 31, 1, 0, 0, false, 0, -1, 1);
