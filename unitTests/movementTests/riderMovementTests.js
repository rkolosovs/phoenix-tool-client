...
define(["require", "exports", "../../armies/riderArmy", "../../gameState", "../../map/field", "../../armies/move", "../../buildings/nonDestructibleBuilding", "../../armies/fleet", "../qunit"], function (require, exports, riderArmy_1, gameState_1, field_1, move_1, nonDestructibleBuilding_1, fleet_1, qunit_1) {
    "use strict";
    ...
    function riderMovementTests() {
        ...
        test("Lowlands -> woods on street", function (t) {
            ...
            gameState_1.GameState.buildings = [new nonDestructibleBuilding_1.NonDestructibleBuilding(8 /* STREET */, [0, 0], [0, -1], gameState_1.GameState.realms[0])];
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(5, 0, false, false, [0, -1], 0 /* NW */));
        });
        ...
        test("Hills -> woods", function (t) {
            ...
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(10, 2, false, false, [0, -1], 0 /* NW */));
        });
        test("Hills -> woods on street", function (t) {
            ...
            gameState_1.GameState.buildings = [new nonDestructibleBuilding_1.NonDestructibleBuilding(8 /* STREET */, [0, 0], [0, -1], gameState_1.GameState.realms[0])];
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(5, 1, false, false, [0, -1], 0 /* NW */));
        });
        test("Hills -> woods in homeland", function (t) {
            ...
            gameState_1.GameState.realms[0].territory = gameState_1.GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(5, 2, false, false, [0, -1], 0 /* NW */));
        });
        ...
        test("Hills -> highlands", function (t) {
            ...
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(21, 2, false, false, [0, -1], 0 /* NW */));
        });
        ...
        test("Shallows -> woods", function (t) {
            ...
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(10, 2, false, true, [0, -1], 0 /* NW */));
        });
        test("Shallows -> woods with harbor", function (t) {
            ...
            gameState_1.GameState.buildings = [new nonDestructibleBuilding_1.NonDestructibleBuilding(6 /* HARBOR */, [0, -1], [0, 0], gameState_1.GameState.realms[0])];
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(10, 1, false, true, [0, -1], 0 /* NW */));
        });
        test("Shallows -> woods in homeland", function (t) {
            ...
            gameState_1.GameState.realms[0].territory = gameState_1.GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(5, 2, false, true, [0, -1], 0 /* NW */));
        });
        test("Shallows -> woods with harbor in homeland", function (t) {
            ...
            gameState_1.GameState.realms[0].territory = gameState_1.GameState.fields.filter(field => field.coordinates[0] === 0 && field.coordinates[1] === -1);
            army.clickedMoves();
            t.movePossible(army.possibleMoves, new move_1.Move(5, 1, false, true, [0, -1], 0 /* NW */));
        });
...
//# sourceMappingURL=riderMovementTests.js.map