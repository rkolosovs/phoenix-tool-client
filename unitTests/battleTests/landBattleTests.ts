...
export function landBattleTests() {
    test( "Minimal armies, defenders win by dice roll.", function(t:any) {
    ...
    test( "Minimal armies, attackers win by dice roll.", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
        t.resultEquals( battleHandler.calculateResult([attackerArmies[0]], [defenderArmies[0]],
            [], [], [0, 0], 9, 2),
            new BattleResult(Result.ATTACKER_VICTORY, [869.57], [1035]));
    });
    test( "Minimal armies, tie (both loose).", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
        t.resultEquals( battleHandler.calculateResult([attackerArmies[0]], [defenderArmies[0]],
            [], [], [0, 0], 5, 5),
            new BattleResult(Result.TIE, [1000], [1000]));
    });
    test( "Different officer count, different rolls, tie (both loose).", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
        t.resultEquals( battleHandler.calculateResult([attackerArmies[0]], [defenderArmies[0]],
            [], [], [0, 0], 7, 3),
            new BattleResult(Result.TIE, [1000], [1000]));
    });
    test( "Riders vs footmen on plains.", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
    ...
    test( "Riders vs footmen in woods.", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [1, 1]);
        t.resultEquals( battleHandler.calculateResult([attackerArmies[1]], [defenderArmies[8]],
            [], [], [1, 1], 4, 4),
            new BattleResult(Result.ATTACKER_VICTORY, [5294.12], [17000]));
    });
    test( "Mixed armies of different compositions on plains.", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
    ...
    test( "Tie with soldier count, officer count and dice roll all different.", function(t:any) {
        let battleHandler: BattleHandler = new BattleHandler([], [0, 0]);
        t.resultEquals( battleHandler.calculateResult([attackerArmies[3]], [defenderArmies[3]],
            [], [], [0, 0], 1, 10),
            new BattleResult(Result.TIE, [1205], [995.85]));
    });
    test( "Combat in attackers home terrain.", function(t:any) {
    ...
    test( "Combat in defenders home terrain.", function(t:any) {
