...
function computePosition(orig: [number, number], curr: [number, number], scale): [number,  number] {
...
function getAdjacency(field: [number, number], candidates: [number, number][]): boolean[] {
